...
export default function PedidosMusicaPage() {
  ...
  return (
    <div style={{ background: S.bg, minHeight: '100vh', padding: '2rem 3rem', maxWidth: '1440px', margin: '0 auto', color: S.text, fontFamily: "-apple-system,'Inter',system-ui,sans-serif", position: 'relative' }}>
      <style>{`
