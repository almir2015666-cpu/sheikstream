...
const C = {
  ...
  primary: '#69c9d0', primaryBg: 'rgba(105,201,208,0.08)',
}

export default function TikTokPlataformaPage() {
  return (
    <div style={{ background: '#08090d', minHeight: '100vh', padding: '1.5rem 2rem', fontFamily: "-apple-system,'Inter',system-ui,sans-serif", color: C.text }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
        ...
        <h2 style={{ margin: 0, fontSize: '1rem', fontWeight: 800 }}>TikTok</h2>
      </div>

      <div style={{ maxWidth: '540px' }}>
        <div style={{ background: C.card, border: `1px solid rgba(105,201,208,0.18)`, borderRadius: '14px', padding: '2.5rem 2rem', textAlign: 'center' }}>
          <div style={{ width: '64px', height: '64px', borderRadius: '16px', background: C.primaryBg, border: `1px solid rgba(105,201,208,0.25)`, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.2rem', fontSize: '2rem', fontWeight: 900, color: C.primary }}>T</div>
          <div style={{ fontWeight: 800, fontSize: '1.1rem', color: C.text, marginBottom: '0.5rem' }}>Conectar TikTok</div>
          <div style={{ fontSize: '0.84rem', color: C.dim, marginBottom: '1.8rem', lineHeight: 1.6 }}>
            Integre sua conta TikTok para monitorar gifts, inscrições e alertas durante suas LIVES.
          </div>
