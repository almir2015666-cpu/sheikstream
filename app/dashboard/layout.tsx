...
const NAV_GROUPS: Group[] = [
  ...
  { label: 'OVERLAYS', items: [
    ...
    { id: 'polling',    label: 'Enquete',   href: '/dashboard/polling',   icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>, badge: 'NOVO' as Badge },
  ]},
