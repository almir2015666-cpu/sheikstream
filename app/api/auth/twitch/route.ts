...
export async function GET(req: NextRequest) {
  ...
  const params = new URLSearchParams({
    ...
    response_type: 'code',
    scope: 'user:read:email user:read:chat user:write:chat user:bot chat:edit channel:read:subscriptions channel:read:goals moderator:read:followers bits:read channel:bot clips:edit',
    force_verify: 'true',
