...
export async function PUT(req: NextRequest) {
  ...
  try {
    ...
    const allowed = ['active','icon','text_main','text_sub','text_note','action_label','action_url','color','text_main_color','text_sub_color','text_note_color','glow','amount_current','amount_goal','supporter_count','position']
