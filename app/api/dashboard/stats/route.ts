...
export async function GET(req: NextRequest) {
  ...
  const [livepixRes, twitchRes, ticketsRes, tierRes] = await Promise.all([
  ...
  // Calculate Twitch total based on actual tier prices
  const twitchTotal = twitchSubs.reduce((s, sub) => {
